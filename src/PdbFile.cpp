...
void PdbFile::write_line(int atom_no, string atom_name, string res, int res_no, coordinates &x, double occupancy, double beta)
{
    oFS << fixed;
    oFS << "ATOM";
    ...
    oFS << setprecision(3);
    oFS << setw(12) << right << x[0];
    oFS << setw(8) << right << x[1];
    oFS << setw(8) << right << x[2];
